...
Write a function called sum() that takes in two numbers
 as arguments and then returns an array where the first e
lement is the sum of those numbers, and the
 second element is a concatenated string that EXACT
 LY follows this example and uses the values that were input into the function:

"The sum of 4 and 7 is 11."

Test this function by hand in the console to get it working, and when you think it is finished,
 uncomment the call for the testSum() function below and
...
array where the first element is the product of those numbers, 
...
Write a function called sumAndMultiply() that takes in three numbers as separate arguments
 ...
 element is the product of those three numbers,  and the third and fourth elements 
...
Test this function by hand in the console to get
 it working, and 
 when you think it is finished,
...
argument and then returns an array where the first element is the sum of the numbers
 in the array, and the second element is a string that EXACTLY follows this example
